...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex flex-col">
      ...
      <div className="flex-1 mt-10 flex items-center justify-center w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="shadow-2xl shadow-blue-500/20 border border-gray-800 w-full max-w-md rounded-lg bg-black p-4 md:rounded-2xl md:p-8">
          ...
          <p className="mt-2 max-w-sm text-sm md:text-base text-neutral-300">
          ...
          <form className=" md:my-8" onSubmit={handleSubmit}>
            ...
            {message && (
              <div className={`mt-4 p-2 sm:p-3 rounded-md text-xs sm:text-sm ${
            ...
            <button
              className="group/btn relative block h-10 w-full rounded-md bg-zinc-800 font-medium text-white shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset] mb-5 cursor-pointer hover:bg-zinc-700 transition-colors"
            ...
            <div className="footer text-center">
              <div className="text-lg md:text-xl font-semibold text-gray-200 mb-2">Delete Account</div>
              <p className="text-white text-justify text-xs sm:text-sm mb-4 sm:mb-5">Warning: This action is permanent. All your data will be deleted forever.</p>
            </div>
